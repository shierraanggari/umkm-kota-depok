    ...
    return (
        ...
        >
            <div className="border border-black rounded p-6 m-5">
                ...
                <button className="border border-black bg-white text-black px-2 py-2 rounded hover:bg-slate-500 hover:text-white hover:border-none transition">Apply Filters</button>
            </div>            
            ...
            <div className="grid grid-cols-1 m-5 md:grid-cols-3 gap-6">
                ...
                <div key={index} className="bg-white/10 border border-gray-700 rounded-lg overflow-hidden">
                    ...
                    <button className="border border-black bg-white text-black w-full py-2 rounded self-end hover:bg-slate-500 hover:text-white hover:border-none transition">View Details</button>
                    </div>
                </div>
                ))}
            </div>
