// File: resources/js/Pages/User/BookmarkedPosts.jsx
import AuthenticatedLayout from '@/Layouts/AuthenticatedLayout';
import { Link, Head } from '@inertiajs/react';
import { Button } from '@/Components/ui/button'; // Jika perlu tombol aksi
import { MessageSquare, ThumbsUp, Eye } from 'lucide-react'; // Contoh ikon

// Komponen Paginasi Sederhana (bisa Anda pindahkan ke file terpisah)
const SimplePagination = ({ links }) => { /* ... (definisi sama seperti sebelumnya) ... */ };
